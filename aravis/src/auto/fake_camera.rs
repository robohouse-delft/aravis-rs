...
impl FakeCamera {
    pub fn new(serial_number: &str) -> FakeCamera {
        ...
        unsafe {
            from_glib_full(aravis_sys::arv_fake_camera_new(serial_number.to_glib_none().0))
        }
    }
    ...
    pub fn new_full(serial_number: &str, genicam_filename: &str) -> FakeCamera {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_full(aravis_sys::arv_fake_camera_new_full(serial_number.to_glib_none().0, genicam_filename.to_glib_none().0))
        }
    }
}
...
impl<O: IsA<FakeCamera>> FakeCameraExt for O {
    fn fill_buffer<P: IsA<Buffer>>(&self, buffer: &P) -> u32 {
        unsafe {
            ...
            aravis_sys::arv_fake_camera_fill_buffer(self.as_ref().to_glib_none().0, buffer.as_ref().to_glib_none().0, packet_size.as_mut_ptr());
    ...
    fn get_control_channel_privilege(&self) -> u32 {
        unsafe {
            aravis_sys::arv_fake_camera_get_control_channel_privilege(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn get_genicam_xml(&self) -> (GString, usize) {
        unsafe {
            ...
            let ret = from_glib_none(aravis_sys::arv_fake_camera_get_genicam_xml(self.as_ref().to_glib_none().0, size.as_mut_ptr()));
    ...
    fn get_heartbeat_timeout(&self) -> u32 {
        unsafe {
            aravis_sys::arv_fake_camera_get_heartbeat_timeout(self.as_ref().to_glib_none().0)
        }
    }

    fn get_payload(&self) -> usize {
        unsafe {
            aravis_sys::arv_fake_camera_get_payload(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn get_sleep_time_for_next_frame(&self) -> (u64, u64) {
        unsafe {
            ...
            let ret = aravis_sys::arv_fake_camera_get_sleep_time_for_next_frame(self.as_ref().to_glib_none().0, next_timestamp_us.as_mut_ptr());
    ...
    fn get_stream_address(&self) -> Option<gio::SocketAddress> {
        unsafe {
            from_glib_full(aravis_sys::arv_fake_camera_get_stream_address(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn read_register(&self, address: u32) -> Option<u32> {
        unsafe {
            ...
            let ret = from_glib(aravis_sys::arv_fake_camera_read_register(self.as_ref().to_glib_none().0, address, value.as_mut_ptr()));
    ...
    fn set_inet_address<P: IsA<gio::InetAddress>>(&self, address: &P) {
        unsafe {
            aravis_sys::arv_fake_camera_set_inet_address(self.as_ref().to_glib_none().0, address.as_ref().to_glib_none().0);
        }
    }

    fn set_trigger_frequency(&self, frequency: f64) {
        unsafe {
            aravis_sys::arv_fake_camera_set_trigger_frequency(self.as_ref().to_glib_none().0, frequency);
        }
    }
    ...
    fn write_register(&self, address: u32, value: u32) -> bool {
        unsafe {
            from_glib(aravis_sys::arv_fake_camera_write_register(self.as_ref().to_glib_none().0, address, value))
        }
    }
}
