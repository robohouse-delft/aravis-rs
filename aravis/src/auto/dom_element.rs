...
impl<O: IsA<DomElement>> DomElementExt for O {
    fn get_attribute(&self, name: &str) -> Option<GString> {
        unsafe {
            from_glib_none(aravis_sys::arv_dom_element_get_attribute(self.as_ref().to_glib_none().0, name.to_glib_none().0))
        }
    }

    fn get_tag_name(&self) -> Option<GString> {
        unsafe {
            from_glib_none(aravis_sys::arv_dom_element_get_tag_name(self.as_ref().to_glib_none().0))
        }
    }

    fn set_attribute(&self, name: &str, attribute_value: &str) {
        unsafe {
            aravis_sys::arv_dom_element_set_attribute(self.as_ref().to_glib_none().0, name.to_glib_none().0, attribute_value.to_glib_none().0);
        }
    }
}
