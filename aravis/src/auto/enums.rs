...
impl fmt::Display for AcquisitionMode {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "AcquisitionMode::{}", match *self {
...
impl fmt::Display for BufferPayloadType {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "BufferPayloadType::{}", match *self {
...
impl ToGlib for BufferPayloadType {
    ...
    fn to_glib(&self) -> aravis_sys::ArvBufferPayloadType {
        match *self {
            ...
            BufferPayloadType::ExtendedChunkData => aravis_sys::ARV_BUFFER_PAYLOAD_TYPE_EXTENDED_CHUNK_DATA,
            ...
            BufferPayloadType::MultizoneImage => aravis_sys::ARV_BUFFER_PAYLOAD_TYPE_MULTIZONE_IMAGE,
            BufferPayloadType::ImageExtendedChunk => aravis_sys::ARV_BUFFER_PAYLOAD_TYPE_IMAGE_EXTENDED_CHUNK,
...
impl fmt::Display for BufferStatus {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "BufferStatus::{}", match *self {
...
impl fmt::Display for DomNodeType {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "DomNodeType::{}", match *self {
...
impl ToGlib for DomNodeType {
    ...
    fn to_glib(&self) -> aravis_sys::ArvDomNodeType {
        match *self {
            ...
            DomNodeType::ProcessingInstructionNode => aravis_sys::ARV_DOM_NODE_TYPE_PROCESSING_INSTRUCTION_NODE,
            ...
            DomNodeType::DocumentFragmentNode => aravis_sys::ARV_DOM_NODE_TYPE_DOCUMENT_FRAGMENT_NODE,
...
impl fmt::Display for GcAccessMode {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "GcAccessMode::{}", match *self {
...
impl fmt::Display for GcNameSpace {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "GcNameSpace::{}", match *self {
...
impl fmt::Display for GcPropertyNodeType {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "GcPropertyNodeType::{}", match *self {
...
impl ToGlib for GcPropertyNodeType {
    ...
    fn to_glib(&self) -> aravis_sys::ArvGcPropertyNodeType {
        match *self {
            ...
            GcPropertyNodeType::ImposedAccessMode => aravis_sys::ARV_GC_PROPERTY_NODE_TYPE_IMPOSED_ACCESS_MODE,
            ...
            GcPropertyNodeType::PIsImplemented => aravis_sys::ARV_GC_PROPERTY_NODE_TYPE_P_IS_IMPLEMENTED,
            GcPropertyNodeType::PIsLocked => aravis_sys::ARV_GC_PROPERTY_NODE_TYPE_P_IS_LOCKED,
            GcPropertyNodeType::PIsAvailable => aravis_sys::ARV_GC_PROPERTY_NODE_TYPE_P_IS_AVAILABLE,
            ...
            GcPropertyNodeType::PCommandValue => aravis_sys::ARV_GC_PROPERTY_NODE_TYPE_P_COMMAND_VALUE,
            GcPropertyNodeType::PValueIndexed => aravis_sys::ARV_GC_PROPERTY_NODE_TYPE_P_VALUE_INDEXED,
            GcPropertyNodeType::PValueDefault => aravis_sys::ARV_GC_PROPERTY_NODE_TYPE_P_VALUE_DEFAULT,
...
impl FromGlib<aravis_sys::ArvGcPropertyNodeType> for GcPropertyNodeType {
    fn from_glib(value: aravis_sys::ArvGcPropertyNodeType) -> Self {
        ...
        match value {
            ...
            4 => GcPropertyNodeType::Tooltip,
            5 => GcPropertyNodeType::DisplayName,
            6 => GcPropertyNodeType::Minimum,
            7 => GcPropertyNodeType::Maximum,
            8 => GcPropertyNodeType::Slope,
            9 => GcPropertyNodeType::Increment,
            10 => GcPropertyNodeType::IsLinear,
            11 => GcPropertyNodeType::Unit,
            12 => GcPropertyNodeType::OnValue,
            13 => GcPropertyNodeType::OffValue,
            14 => GcPropertyNodeType::Length,
            15 => GcPropertyNodeType::Formula,
            16 => GcPropertyNodeType::FormulaTo,
            17 => GcPropertyNodeType::FormulaFrom,
            18 => GcPropertyNodeType::Expression,
            19 => GcPropertyNodeType::Constant,
            20 => GcPropertyNodeType::AccessMode,
            21 => GcPropertyNodeType::ImposedAccessMode,
            22 => GcPropertyNodeType::Cachable,
            23 => GcPropertyNodeType::PollingTime,
            24 => GcPropertyNodeType::Endianess,
            25 => GcPropertyNodeType::Sign,
            26 => GcPropertyNodeType::Lsb,
            27 => GcPropertyNodeType::Msb,
            28 => GcPropertyNodeType::Bit,
            29 => GcPropertyNodeType::CommandValue,
            30 => GcPropertyNodeType::ChunkId,
            31 => GcPropertyNodeType::EventId,
            32 => GcPropertyNodeType::ValueIndexed,
            33 => GcPropertyNodeType::ValueDefault,
...
impl fmt::Display for GcSignedness {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "GcSignedness::{}", match *self {
...
impl fmt::Display for GvStreamOption {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "GvStreamOption::{}", match *self {
...
impl ToGlib for GvStreamOption {
    ...
    fn to_glib(&self) -> aravis_sys::ArvGvStreamOption {
        match *self {
            ...
            GvStreamOption::PacketSocketDisabled => aravis_sys::ARV_GV_STREAM_OPTION_PACKET_SOCKET_DISABLED,
...
impl fmt::Display for GvStreamPacketResend {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "GvStreamPacketResend::{}", match *self {
...
impl fmt::Display for GvStreamSocketBuffer {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "GvStreamSocketBuffer::{}", match *self {
...
impl fmt::Display for RegisterCachePolicy {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "RegisterCachePolicy::{}", match *self {
...
impl fmt::Display for XmlSchemaError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "XmlSchemaError::{}", match *self {
