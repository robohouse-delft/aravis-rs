...
pub const ARV_GC_PROPERTY_NODE_TYPE_UNIT: ArvGcPropertyNodeType = 12;
pub const ARV_GC_PROPERTY_NODE_TYPE_ON_VALUE: ArvGcPropertyNodeType = 13;
pub const ARV_GC_PROPERTY_NODE_TYPE_OFF_VALUE: ArvGcPropertyNodeType = 14;
pub const ARV_GC_PROPERTY_NODE_TYPE_LENGTH: ArvGcPropertyNodeType = 15;
pub const ARV_GC_PROPERTY_NODE_TYPE_FORMULA: ArvGcPropertyNodeType = 16;
pub const ARV_GC_PROPERTY_NODE_TYPE_FORMULA_TO: ArvGcPropertyNodeType = 17;
pub const ARV_GC_PROPERTY_NODE_TYPE_FORMULA_FROM: ArvGcPropertyNodeType = 18;
pub const ARV_GC_PROPERTY_NODE_TYPE_EXPRESSION: ArvGcPropertyNodeType = 19;
pub const ARV_GC_PROPERTY_NODE_TYPE_CONSTANT: ArvGcPropertyNodeType = 20;
pub const ARV_GC_PROPERTY_NODE_TYPE_ACCESS_MODE: ArvGcPropertyNodeType = 21;
pub const ARV_GC_PROPERTY_NODE_TYPE_IMPOSED_ACCESS_MODE: ArvGcPropertyNodeType = 22;
pub const ARV_GC_PROPERTY_NODE_TYPE_CACHABLE: ArvGcPropertyNodeType = 23;
pub const ARV_GC_PROPERTY_NODE_TYPE_POLLING_TIME: ArvGcPropertyNodeType = 24;
pub const ARV_GC_PROPERTY_NODE_TYPE_ENDIANESS: ArvGcPropertyNodeType = 25;
pub const ARV_GC_PROPERTY_NODE_TYPE_SIGN: ArvGcPropertyNodeType = 26;
pub const ARV_GC_PROPERTY_NODE_TYPE_LSB: ArvGcPropertyNodeType = 27;
pub const ARV_GC_PROPERTY_NODE_TYPE_MSB: ArvGcPropertyNodeType = 28;
pub const ARV_GC_PROPERTY_NODE_TYPE_BIT: ArvGcPropertyNodeType = 29;
pub const ARV_GC_PROPERTY_NODE_TYPE_COMMAND_VALUE: ArvGcPropertyNodeType = 30;
pub const ARV_GC_PROPERTY_NODE_TYPE_CHUNK_ID: ArvGcPropertyNodeType = 31;
pub const ARV_GC_PROPERTY_NODE_TYPE_EVENT_ID: ArvGcPropertyNodeType = 32;
pub const ARV_GC_PROPERTY_NODE_TYPE_VALUE_INDEXED: ArvGcPropertyNodeType = 33;
pub const ARV_GC_PROPERTY_NODE_TYPE_VALUE_DEFAULT: ArvGcPropertyNodeType = 34;
...
pub struct ArvDeviceClass {
	...
	pub create_stream: Option<
		unsafe extern "C" fn(*mut ArvDevice, ArvStreamCallback, *mut c_void) -> *mut ArvStream,
	>,
...
pub struct ArvGcFloatInterface {
	...
	pub get_unit:
		Option<unsafe extern "C" fn(*mut ArvGcFloat, *mut *mut glib::GError) -> *const c_char>,
...
pub struct ArvGcIntegerInterface {
	...
	pub get_unit:
		Option<unsafe extern "C" fn(*mut ArvGcInteger, *mut *mut glib::GError) -> *const c_char>,
...
pub struct ArvInterfaceClass {
	...
	pub open_device:
		Option<unsafe extern "C" fn(*mut ArvInterface, *const c_char) -> *mut ArvDevice>,
...
extern "C" {
	...
	pub fn arv_camera_check_status(
		camera: *mut ArvCamera,
		error: *mut *mut glib::GError,
	) -> gboolean;
	...
	pub fn arv_camera_get_available_enumerations(
		camera: *mut ArvCamera,
		feature: *const c_char,
		n_values: *mut c_uint,
		error: *mut *mut glib::GError,
	) -> *mut i64;
	pub fn arv_camera_get_available_enumerations_as_display_names(
		camera: *mut ArvCamera,
		feature: *const c_char,
		n_values: *mut c_uint,
		error: *mut *mut glib::GError,
	) -> *mut *const c_char;
	pub fn arv_camera_get_available_enumerations_as_strings(
		camera: *mut ArvCamera,
		feature: *const c_char,
		n_values: *mut c_uint,
		error: *mut *mut glib::GError,
	) -> *mut *const c_char;
	pub fn arv_camera_get_available_pixel_formats(
		camera: *mut ArvCamera,
		n_pixel_formats: *mut c_uint,
		error: *mut *mut glib::GError,
	) -> *mut i64;
	pub fn arv_camera_get_available_pixel_formats_as_display_names(
		camera: *mut ArvCamera,
		n_pixel_formats: *mut c_uint,
		error: *mut *mut glib::GError,
	) -> *mut *const c_char;
	pub fn arv_camera_get_available_pixel_formats_as_strings(
		camera: *mut ArvCamera,
		n_pixel_formats: *mut c_uint,
		error: *mut *mut glib::GError,
	) -> *mut *const c_char;
	pub fn arv_camera_get_available_trigger_sources(
		camera: *mut ArvCamera,
		n_sources: *mut c_uint,
		error: *mut *mut glib::GError,
	) -> *mut *const c_char;
	pub fn arv_camera_get_available_triggers(
		camera: *mut ArvCamera,
	...
	pub fn arv_device_get_available_enumeration_feature_values(
		device: *mut ArvDevice,
		feature: *const c_char,
		n_values: *mut c_uint,
		error: *mut *mut glib::GError,
	) -> *mut i64;
	pub fn arv_device_get_available_enumeration_feature_values_as_display_names(
		device: *mut ArvDevice,
		feature: *const c_char,
		n_values: *mut c_uint,
		error: *mut *mut glib::GError,
	) -> *mut *const c_char;
	pub fn arv_device_get_available_enumeration_feature_values_as_strings(
		device: *mut ArvDevice,
		feature: *const c_char,
		n_values: *mut c_uint,
		error: *mut *mut glib::GError,
	...
	pub fn arv_gc_enumeration_get_available_display_names(
		enumeration: *mut ArvGcEnumeration,
		n_values: *mut c_uint,
		error: *mut *mut glib::GError,
	) -> *mut *const c_char;
	pub fn arv_gc_enumeration_get_available_int_values(
		enumeration: *mut ArvGcEnumeration,
		n_values: *mut c_uint,
		error: *mut *mut glib::GError,
	) -> *mut i64;
	pub fn arv_gc_enumeration_get_available_string_values(
		enumeration: *mut ArvGcEnumeration,
		n_values: *mut c_uint,
		error: *mut *mut glib::GError,
	) -> *mut *const c_char;
	...
	pub fn arv_gc_property_node_get_endianess(
		self_: *mut ArvGcPropertyNode,
	...
	pub fn arv_gc_integer_get_unit(
		gc_integer: *mut ArvGcInteger,
		error: *mut *mut glib::GError,
	) -> *const c_char;
