...
pub struct ArvDeviceClass {
    pub parent_class: gobject::GObjectClass,
    pub create_stream: Option<unsafe extern "C" fn(*mut ArvDevice, ArvStreamCallback, *mut c_void, *mut *mut glib::GError) -> *mut ArvStream>,
...
impl ::std::fmt::Debug for ArvDomNodeChildListClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("ArvDomNodeChildListClass @ {:?}", self as *const _))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
pub struct ArvGcFeatureNodeClass {
    ...
    pub get_linked_feature: Option<unsafe extern "C" fn(*mut ArvGcFeatureNode) -> *mut ArvGcFeatureNode>,
...
pub struct ArvInterfaceClass {
    ...
    pub open_device: Option<unsafe extern "C" fn(*mut ArvInterface, *const c_char, *mut *mut glib::GError) -> *mut ArvDevice>,
...
impl ::std::fmt::Debug for ArvDomNodeChildList {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("ArvDomNodeChildList @ {:?}", self as *const _))
         .finish()
    }
}
...
extern "C" {
    ...
    pub fn arv_camera_acquisition(camera: *mut ArvCamera, timeout: u64, error: *mut *mut glib::GError) -> *mut ArvBuffer;
    ...
    pub fn arv_camera_create_stream(camera: *mut ArvCamera, callback: ArvStreamCallback, user_data: *mut c_void, error: *mut *mut glib::GError) -> *mut ArvStream;
    pub fn arv_camera_dup_available_enumerations(camera: *mut ArvCamera, feature: *const c_char, n_values: *mut c_uint, error: *mut *mut glib::GError) -> *mut i64;
    pub fn arv_camera_dup_available_enumerations_as_display_names(camera: *mut ArvCamera, feature: *const c_char, n_values: *mut c_uint, error: *mut *mut glib::GError) -> *mut *const c_char;
    pub fn arv_camera_dup_available_enumerations_as_strings(camera: *mut ArvCamera, feature: *const c_char, n_values: *mut c_uint, error: *mut *mut glib::GError) -> *mut *const c_char;
    pub fn arv_camera_dup_available_pixel_formats(camera: *mut ArvCamera, n_pixel_formats: *mut c_uint, error: *mut *mut glib::GError) -> *mut i64;
    pub fn arv_camera_dup_available_pixel_formats_as_display_names(camera: *mut ArvCamera, n_pixel_formats: *mut c_uint, error: *mut *mut glib::GError) -> *mut *const c_char;
    pub fn arv_camera_dup_available_pixel_formats_as_strings(camera: *mut ArvCamera, n_pixel_formats: *mut c_uint, error: *mut *mut glib::GError) -> *mut *const c_char;
    pub fn arv_camera_dup_available_trigger_sources(camera: *mut ArvCamera, n_sources: *mut c_uint, error: *mut *mut glib::GError) -> *mut *const c_char;
    pub fn arv_camera_dup_available_triggers(camera: *mut ArvCamera, n_triggers: *mut c_uint, error: *mut *mut glib::GError) -> *mut *const c_char;
    pub fn arv_camera_execute_command(camera: *mut ArvCamera, feature: *const c_char, error: *mut *mut glib::GError);
    pub fn arv_camera_get_acquisition_mode(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> ArvAcquisitionMode;
    pub fn arv_camera_get_binning(camera: *mut ArvCamera, dx: *mut c_int, dy: *mut c_int, error: *mut *mut glib::GError);
    pub fn arv_camera_get_boolean(camera: *mut ArvCamera, feature: *const c_char, error: *mut *mut glib::GError) -> gboolean;
    pub fn arv_camera_get_boolean_gi(camera: *mut ArvCamera, feature: *const c_char, value: *mut gboolean, error: *mut *mut glib::GError);
    pub fn arv_camera_get_chunk_mode(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> gboolean;
    pub fn arv_camera_get_chunk_state(camera: *mut ArvCamera, chunk: *const c_char, error: *mut *mut glib::GError) -> gboolean;
    pub fn arv_camera_get_device(camera: *mut ArvCamera) -> *mut ArvDevice;
    pub fn arv_camera_get_device_id(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> *const c_char;
    pub fn arv_camera_get_exposure_time(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> c_double;
    pub fn arv_camera_get_exposure_time_auto(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> ArvAuto;
    pub fn arv_camera_get_exposure_time_bounds(camera: *mut ArvCamera, min: *mut c_double, max: *mut c_double, error: *mut *mut glib::GError);
    pub fn arv_camera_get_float(camera: *mut ArvCamera, feature: *const c_char, error: *mut *mut glib::GError) -> c_double;
    pub fn arv_camera_get_float_bounds(camera: *mut ArvCamera, feature: *const c_char, min: *mut c_double, max: *mut c_double, error: *mut *mut glib::GError);
    pub fn arv_camera_get_frame_count(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> i64;
    pub fn arv_camera_get_frame_count_bounds(camera: *mut ArvCamera, min: *mut i64, max: *mut i64, error: *mut *mut glib::GError);
    pub fn arv_camera_get_frame_rate(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> c_double;
    pub fn arv_camera_get_frame_rate_bounds(camera: *mut ArvCamera, min: *mut c_double, max: *mut c_double, error: *mut *mut glib::GError);
    pub fn arv_camera_get_gain(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> c_double;
    pub fn arv_camera_get_gain_auto(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> ArvAuto;
    pub fn arv_camera_get_gain_bounds(camera: *mut ArvCamera, min: *mut c_double, max: *mut c_double, error: *mut *mut glib::GError);
    pub fn arv_camera_get_height_bounds(camera: *mut ArvCamera, min: *mut c_int, max: *mut c_int, error: *mut *mut glib::GError);
    pub fn arv_camera_get_height_increment(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> c_int;
    pub fn arv_camera_get_integer(camera: *mut ArvCamera, feature: *const c_char, error: *mut *mut glib::GError) -> i64;
    pub fn arv_camera_get_integer_bounds(camera: *mut ArvCamera, feature: *const c_char, min: *mut i64, max: *mut i64, error: *mut *mut glib::GError);
    pub fn arv_camera_get_integer_increment(camera: *mut ArvCamera, feature: *const c_char, error: *mut *mut glib::GError) -> i64;
    pub fn arv_camera_get_model_name(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> *const c_char;
    pub fn arv_camera_get_payload(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> c_uint;
    pub fn arv_camera_get_pixel_format(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> ArvPixelFormat;
    pub fn arv_camera_get_pixel_format_as_string(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> *const c_char;
    pub fn arv_camera_get_region(camera: *mut ArvCamera, x: *mut c_int, y: *mut c_int, width: *mut c_int, height: *mut c_int, error: *mut *mut glib::GError);
    pub fn arv_camera_get_sensor_size(camera: *mut ArvCamera, width: *mut c_int, height: *mut c_int, error: *mut *mut glib::GError);
    pub fn arv_camera_get_string(camera: *mut ArvCamera, feature: *const c_char, error: *mut *mut glib::GError) -> *const c_char;
    pub fn arv_camera_get_trigger_source(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> *const c_char;
    pub fn arv_camera_get_vendor_name(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> *const c_char;
    pub fn arv_camera_get_width_bounds(camera: *mut ArvCamera, min: *mut c_int, max: *mut c_int, error: *mut *mut glib::GError);
    pub fn arv_camera_get_width_increment(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> c_int;
    pub fn arv_camera_get_x_binning_bounds(camera: *mut ArvCamera, min: *mut c_int, max: *mut c_int, error: *mut *mut glib::GError);
    pub fn arv_camera_get_x_binning_increment(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> c_int;
    pub fn arv_camera_get_x_offset_bounds(camera: *mut ArvCamera, min: *mut c_int, max: *mut c_int, error: *mut *mut glib::GError);
    pub fn arv_camera_get_x_offset_increment(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> c_int;
    pub fn arv_camera_get_y_binning_bounds(camera: *mut ArvCamera, min: *mut c_int, max: *mut c_int, error: *mut *mut glib::GError);
    pub fn arv_camera_get_y_binning_increment(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> c_int;
    pub fn arv_camera_get_y_offset_bounds(camera: *mut ArvCamera, min: *mut c_int, max: *mut c_int, error: *mut *mut glib::GError);
    pub fn arv_camera_get_y_offset_increment(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> c_int;
    pub fn arv_camera_gv_auto_packet_size(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> c_uint;
    pub fn arv_camera_gv_get_current_stream_channel(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> c_int;
    pub fn arv_camera_gv_get_n_stream_channels(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> c_int;
    pub fn arv_camera_gv_get_packet_delay(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> i64;
    pub fn arv_camera_gv_get_packet_size(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> c_uint;
    pub fn arv_camera_gv_select_stream_channel(camera: *mut ArvCamera, channel_id: c_int, error: *mut *mut glib::GError);
    pub fn arv_camera_gv_set_packet_delay(camera: *mut ArvCamera, delay_ns: i64, error: *mut *mut glib::GError);
    pub fn arv_camera_gv_set_packet_size(camera: *mut ArvCamera, packet_size: c_int, error: *mut *mut glib::GError);
    #[cfg(any(feature = "v0_8_3", feature = "dox"))]
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v0_8_3")))]
    pub fn arv_camera_gv_set_packet_size_adjustment(camera: *mut ArvCamera, adjustment: ArvGvPacketSizeAdjustment);
    pub fn arv_camera_gv_set_stream_options(camera: *mut ArvCamera, options: ArvGvStreamOption);
    pub fn arv_camera_is_binning_available(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> gboolean;
    pub fn arv_camera_is_exposure_auto_available(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> gboolean;
    pub fn arv_camera_is_exposure_time_available(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> gboolean;
    pub fn arv_camera_is_feature_available(camera: *mut ArvCamera, feature: *const c_char, error: *mut *mut glib::GError) -> gboolean;
    pub fn arv_camera_is_frame_rate_available(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> gboolean;
    pub fn arv_camera_is_gain_auto_available(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> gboolean;
    pub fn arv_camera_is_gain_available(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> gboolean;
    pub fn arv_camera_is_gv_device(camera: *mut ArvCamera) -> gboolean;
    pub fn arv_camera_is_uv_device(camera: *mut ArvCamera) -> gboolean;
    pub fn arv_camera_set_acquisition_mode(camera: *mut ArvCamera, value: ArvAcquisitionMode, error: *mut *mut glib::GError);
    pub fn arv_camera_set_binning(camera: *mut ArvCamera, dx: c_int, dy: c_int, error: *mut *mut glib::GError);
    pub fn arv_camera_set_boolean(camera: *mut ArvCamera, feature: *const c_char, value: gboolean, error: *mut *mut glib::GError);
    pub fn arv_camera_set_chunk_mode(camera: *mut ArvCamera, is_active: gboolean, error: *mut *mut glib::GError);
    pub fn arv_camera_set_chunk_state(camera: *mut ArvCamera, chunk: *const c_char, is_enabled: gboolean, error: *mut *mut glib::GError);
    pub fn arv_camera_set_chunks(camera: *mut ArvCamera, chunk_list: *const c_char, error: *mut *mut glib::GError);
    pub fn arv_camera_set_exposure_time(camera: *mut ArvCamera, exposure_time_us: c_double, error: *mut *mut glib::GError);
    pub fn arv_camera_set_exposure_time_auto(camera: *mut ArvCamera, auto_mode: ArvAuto, error: *mut *mut glib::GError);
    pub fn arv_camera_set_float(camera: *mut ArvCamera, feature: *const c_char, value: c_double, error: *mut *mut glib::GError);
    pub fn arv_camera_set_frame_count(camera: *mut ArvCamera, frame_count: i64, error: *mut *mut glib::GError);
    pub fn arv_camera_set_frame_rate(camera: *mut ArvCamera, frame_rate: c_double, error: *mut *mut glib::GError);
    pub fn arv_camera_set_gain(camera: *mut ArvCamera, gain: c_double, error: *mut *mut glib::GError);
    pub fn arv_camera_set_gain_auto(camera: *mut ArvCamera, auto_mode: ArvAuto, error: *mut *mut glib::GError);
    pub fn arv_camera_set_integer(camera: *mut ArvCamera, feature: *const c_char, value: i64, error: *mut *mut glib::GError);
    pub fn arv_camera_set_pixel_format(camera: *mut ArvCamera, format: ArvPixelFormat, error: *mut *mut glib::GError);
    pub fn arv_camera_set_pixel_format_from_string(camera: *mut ArvCamera, format: *const c_char, error: *mut *mut glib::GError);
    pub fn arv_camera_set_region(camera: *mut ArvCamera, x: c_int, y: c_int, width: c_int, height: c_int, error: *mut *mut glib::GError);
    pub fn arv_camera_set_string(camera: *mut ArvCamera, feature: *const c_char, value: *const c_char, error: *mut *mut glib::GError);
    pub fn arv_camera_set_trigger(camera: *mut ArvCamera, source: *const c_char, error: *mut *mut glib::GError);
    pub fn arv_camera_set_trigger_source(camera: *mut ArvCamera, source: *const c_char, error: *mut *mut glib::GError);
    ...
    pub fn arv_camera_uv_get_bandwidth(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> c_uint;
    pub fn arv_camera_uv_get_bandwidth_bounds(camera: *mut ArvCamera, min: *mut c_uint, max: *mut c_uint, error: *mut *mut glib::GError);
    pub fn arv_camera_uv_is_bandwidth_control_available(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> gboolean;
    pub fn arv_camera_uv_set_bandwidth(camera: *mut ArvCamera, bandwidth: c_uint, error: *mut *mut glib::GError);
    ...
    pub fn arv_device_create_stream(device: *mut ArvDevice, callback: ArvStreamCallback, user_data: *mut c_void, error: *mut *mut glib::GError) -> *mut ArvStream;
    pub fn arv_device_dup_available_enumeration_feature_values(device: *mut ArvDevice, feature: *const c_char, n_values: *mut c_uint, error: *mut *mut glib::GError) -> *mut i64;
    pub fn arv_device_dup_available_enumeration_feature_values_as_display_names(device: *mut ArvDevice, feature: *const c_char, n_values: *mut c_uint, error: *mut *mut glib::GError) -> *mut *const c_char;
    pub fn arv_device_dup_available_enumeration_feature_values_as_strings(device: *mut ArvDevice, feature: *const c_char, n_values: *mut c_uint, error: *mut *mut glib::GError) -> *mut *const c_char;
    ...
    pub fn arv_device_get_boolean_feature_value_gi(device: *mut ArvDevice, feature: *const c_char, value: *mut gboolean, error: *mut *mut glib::GError);
    ...
    pub fn arv_device_is_feature_available(device: *mut ArvDevice, feature: *const c_char, error: *mut *mut glib::GError) -> gboolean;
    ...
    pub fn arv_device_set_features_from_string(device: *mut ArvDevice, string: *const c_char, error: *mut *mut glib::GError) -> gboolean;
    ...
    pub fn arv_fake_device_new(serial_number: *const c_char, error: *mut *mut glib::GError) -> *mut ArvDevice;
    ...
    pub fn arv_gc_boolean_get_value_gi(gc_boolean: *mut ArvGcBoolean, value: *mut gboolean, error: *mut *mut glib::GError);
    ...
    pub fn arv_gc_enumeration_dup_available_display_names(enumeration: *mut ArvGcEnumeration, n_values: *mut c_uint, error: *mut *mut glib::GError) -> *mut *const c_char;
    pub fn arv_gc_enumeration_dup_available_int_values(enumeration: *mut ArvGcEnumeration, n_values: *mut c_uint, error: *mut *mut glib::GError) -> *mut i64;
    pub fn arv_gc_enumeration_dup_available_string_values(enumeration: *mut ArvGcEnumeration, n_values: *mut c_uint, error: *mut *mut glib::GError) -> *mut *const c_char;
    ...
    pub fn arv_gc_enumeration_set_int_value(enumeration: *mut ArvGcEnumeration, value: i64, error: *mut *mut glib::GError) -> gboolean;
    pub fn arv_gc_enumeration_set_string_value(enumeration: *mut ArvGcEnumeration, value: *const c_char, error: *mut *mut glib::GError) -> gboolean;

    //=========================================================================
    // ArvGcFeatureNode
    //=========================================================================
    pub fn arv_gc_feature_node_get_type() -> GType;
    pub fn arv_gc_feature_node_get_actual_access_mode(gc_feature_node: *mut ArvGcFeatureNode) -> ArvGcAccessMode;
    pub fn arv_gc_feature_node_get_description(gc_feature_node: *mut ArvGcFeatureNode) -> *const c_char;
    pub fn arv_gc_feature_node_get_display_name(gc_feature_node: *mut ArvGcFeatureNode) -> *const c_char;
    pub fn arv_gc_feature_node_get_imposed_access_mode(gc_feature_node: *mut ArvGcFeatureNode) -> ArvGcAccessMode;
    pub fn arv_gc_feature_node_get_name(gc_feature_node: *mut ArvGcFeatureNode) -> *const c_char;
    pub fn arv_gc_feature_node_get_name_space(gc_feature_node: *mut ArvGcFeatureNode) -> ArvGcNameSpace;
    pub fn arv_gc_feature_node_get_tooltip(gc_feature_node: *mut ArvGcFeatureNode) -> *const c_char;
    ...
    pub fn arv_gc_feature_node_get_visibility(gc_feature_node: *mut ArvGcFeatureNode) -> ArvGcVisibility;
    ...
    pub fn arv_gc_property_node_get_display_notation(self_: *mut ArvGcPropertyNode, default_value: ArvGcDisplayNotation) -> ArvGcDisplayNotation;
    pub fn arv_gc_property_node_get_display_precision(self_: *mut ArvGcPropertyNode, default_value: i64) -> i64;
    pub fn arv_gc_property_node_get_double(node: *mut ArvGcPropertyNode, error: *mut *mut glib::GError) -> c_double;
    pub fn arv_gc_property_node_get_endianness(self_: *mut ArvGcPropertyNode, default_value: c_uint) -> c_uint;
    ...
    pub fn arv_gc_property_node_get_representation(self_: *mut ArvGcPropertyNode, default_value: ArvGcRepresentation) -> ArvGcRepresentation;
    ...
    pub fn arv_gc_property_node_get_visibility(self_: *mut ArvGcPropertyNode, default_value: ArvGcVisibility) -> ArvGcVisibility;
    ...
    pub fn arv_gc_register_description_node_get_major_version(node: *mut ArvGcRegisterDescriptionNode) -> c_uint;
    pub fn arv_gc_register_description_node_get_minor_version(node: *mut ArvGcRegisterDescriptionNode) -> c_uint;
    pub fn arv_gc_register_description_node_get_model_name(node: *mut ArvGcRegisterDescriptionNode) -> *mut c_char;
    pub fn arv_gc_register_description_node_get_schema_major_version(node: *mut ArvGcRegisterDescriptionNode) -> c_uint;
    pub fn arv_gc_register_description_node_get_schema_minor_version(node: *mut ArvGcRegisterDescriptionNode) -> c_uint;
    pub fn arv_gc_register_description_node_get_schema_subminor_version(node: *mut ArvGcRegisterDescriptionNode) -> c_uint;
    pub fn arv_gc_register_description_node_get_subminor_version(node: *mut ArvGcRegisterDescriptionNode) -> c_uint;
    pub fn arv_gc_register_description_node_get_vendor_name(node: *mut ArvGcRegisterDescriptionNode) -> *mut c_char;
    ...
    pub fn arv_gv_device_new(interface_address: *mut gio::GInetAddress, device_address: *mut gio::GInetAddress, error: *mut *mut glib::GError) -> *mut ArvDevice;
    pub fn arv_gv_device_auto_packet_size(gv_device: *mut ArvGvDevice, error: *mut *mut glib::GError) -> c_uint;
    ...
    pub fn arv_gv_device_get_packet_size(gv_device: *mut ArvGvDevice, error: *mut *mut glib::GError) -> c_uint;
    pub fn arv_gv_device_get_stream_options(gv_device: *mut ArvGvDevice) -> ArvGvStreamOption;
    pub fn arv_gv_device_get_timestamp_tick_frequency(gv_device: *mut ArvGvDevice, error: *mut *mut glib::GError) -> u64;
    pub fn arv_gv_device_is_controller(gv_device: *mut ArvGvDevice) -> gboolean;
    #[cfg(any(feature = "v0_8_3", feature = "dox"))]
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v0_8_3")))]
    pub fn arv_gv_device_leave_control(gv_device: *mut ArvGvDevice, error: *mut *mut glib::GError) -> gboolean;
    pub fn arv_gv_device_set_packet_size(gv_device: *mut ArvGvDevice, packet_size: c_int, error: *mut *mut glib::GError);
    #[cfg(any(feature = "v0_8_3", feature = "dox"))]
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v0_8_3")))]
    pub fn arv_gv_device_set_packet_size_adjustment(gv_device: *mut ArvGvDevice, adjustment: ArvGvPacketSizeAdjustment);
    pub fn arv_gv_device_set_stream_options(gv_device: *mut ArvGvDevice, options: ArvGvStreamOption);
    #[cfg(any(feature = "v0_8_3", feature = "dox"))]
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v0_8_3")))]
    pub fn arv_gv_device_take_control(gv_device: *mut ArvGvDevice, error: *mut *mut glib::GError) -> gboolean;
    ...
    pub fn arv_interface_open_device(interface: *mut ArvInterface, device_id: *const c_char, error: *mut *mut glib::GError) -> *mut ArvDevice;
    ...
    pub fn arv_uv_device_new(vendor: *const c_char, product: *const c_char, serial_number: *const c_char, error: *mut *mut glib::GError) -> *mut ArvDevice;
    ...
    pub fn arv_open_device(device_id: *const c_char, error: *mut *mut glib::GError) -> *mut ArvDevice;
