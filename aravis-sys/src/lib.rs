// This file was generated by gir (https://github.com/gtk-rs/gir @ 8335272)
// from gir-files (https://github.com/gtk-rs/gir-files @ f375532+)
// DO NOT EDIT
...
extern "C" {
    ...
    pub fn arv_camera_check_status(camera: *mut ArvCamera, error: *mut *mut glib::GError) -> gboolean;
    ...
    pub fn arv_camera_get_available_enumerations(camera: *mut ArvCamera, feature: *const c_char, n_values: *mut c_uint, error: *mut *mut glib::GError) -> *mut i64;
    pub fn arv_camera_get_available_enumerations_as_display_names(camera: *mut ArvCamera, feature: *const c_char, n_values: *mut c_uint, error: *mut *mut glib::GError) -> *mut *const c_char;
    pub fn arv_camera_get_available_enumerations_as_strings(camera: *mut ArvCamera, feature: *const c_char, n_values: *mut c_uint, error: *mut *mut glib::GError) -> *mut *const c_char;
    pub fn arv_camera_get_available_pixel_formats(camera: *mut ArvCamera, n_pixel_formats: *mut c_uint, error: *mut *mut glib::GError) -> *mut i64;
    pub fn arv_camera_get_available_pixel_formats_as_display_names(camera: *mut ArvCamera, n_pixel_formats: *mut c_uint, error: *mut *mut glib::GError) -> *mut *const c_char;
    pub fn arv_camera_get_available_pixel_formats_as_strings(camera: *mut ArvCamera, n_pixel_formats: *mut c_uint, error: *mut *mut glib::GError) -> *mut *const c_char;
    pub fn arv_camera_get_available_trigger_sources(camera: *mut ArvCamera, n_sources: *mut c_uint, error: *mut *mut glib::GError) -> *mut *const c_char;
    pub fn arv_camera_get_available_triggers(camera: *mut ArvCamera, n_triggers: *mut c_uint, error: *mut *mut glib::GError) -> *mut *const c_char;
