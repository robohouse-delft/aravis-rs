...
const RUST_LAYOUTS: &[(&str, Layout)] = &[
	...
	(
		"ArvDebugCategory",
		Layout {
			size: size_of::<ArvDebugCategory>(),
			alignment: align_of::<ArvDebugCategory>(),
		},
	),
	(
		"ArvDebugLevel",
		Layout {
			size: size_of::<ArvDebugLevel>(),
			alignment: align_of::<ArvDebugLevel>(),
		},
	),
	(
		"ArvDevice",
...
const RUST_CONSTANTS: &[(&str, &str)] = &[
	...
	(
		"(gint) ARV_BUFFER_PAYLOAD_TYPE_IMAGE_EXTENDED_CHUNK",
		"16385",
	),
	...
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_ACCESS_MODE", "21"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_ADDRESS", "2"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_BIT", "29"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_CACHABLE", "23"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_CHUNK_ID", "31"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_COMMAND_VALUE", "30"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_CONSTANT", "20"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_DESCRIPTION", "3"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_DISPLAY_NAME", "6"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_ENDIANESS", "25"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_EVENT_ID", "32"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_EXPRESSION", "19"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_FORMULA", "16"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_FORMULA_FROM", "18"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_FORMULA_TO", "17"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_IMPOSED_ACCESS_MODE", "22"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_INCREMENT", "10"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_IS_LINEAR", "11"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_LENGTH", "15"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_LSB", "27"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_MAXIMUM", "8"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_MINIMUM", "7"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_MSB", "28"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_OFF_VALUE", "14"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_ON_VALUE", "13"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_POLLING_TIME", "24"),
	...
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_SIGN", "26"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_SLOPE", "9"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_TOOLTIP", "5"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_UNIT", "12"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_UNKNOWN", "0"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_VALUE", "1"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_VALUE_DEFAULT", "34"),
	("(gint) ARV_GC_PROPERTY_NODE_TYPE_VALUE_INDEXED", "33"),
