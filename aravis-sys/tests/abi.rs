...
const RUST_LAYOUTS: &[(&str, Layout)] = &[
    ...
    ("ArvDebugCategory", Layout {size: size_of::<ArvDebugCategory>(), alignment: align_of::<ArvDebugCategory>()}),
    ("ArvDebugLevel", Layout {size: size_of::<ArvDebugLevel>(), alignment: align_of::<ArvDebugLevel>()}),
    ...
    ("ArvStatus", Layout {size: size_of::<ArvStatus>(), alignment: align_of::<ArvStatus>()}),
...
const RUST_CONSTANTS: &[(&str, &str)] = &[
    ...
    ("(gint) ARV_DEBUG_LEVEL_COUNT", "4"),
    ("(gint) ARV_DEBUG_LEVEL_DEBUG", "2"),
    ("(gint) ARV_DEBUG_LEVEL_LOG", "3"),
    ("(gint) ARV_DEBUG_LEVEL_NONE", "0"),
    ("(gint) ARV_DEBUG_LEVEL_WARNING", "1"),
    ...
    ("(gint) ARV_GC_ERROR_GET_AS_STRING_UNDEFINED", "11"),
    ("(gint) ARV_GC_ERROR_INVALID_LENGTH", "8"),
    ...
    ("(gint) ARV_GC_ERROR_READ_ONLY", "9"),
    ("(gint) ARV_GC_ERROR_SET_FROM_STRING_UNDEFINED", "10"),
    ...
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_ACCESS_MODE", "20"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_ADDRESS", "2"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_BIT", "28"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_CACHABLE", "22"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_CHUNK_ID", "30"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_COMMAND_VALUE", "29"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_CONSTANT", "19"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_DESCRIPTION", "3"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_DISPLAY_NAME", "5"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_ENDIANESS", "24"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_EVENT_ID", "31"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_EXPRESSION", "18"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_FORMULA", "15"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_FORMULA_FROM", "17"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_FORMULA_TO", "16"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_IMPOSED_ACCESS_MODE", "21"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_INCREMENT", "9"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_IS_LINEAR", "10"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_LENGTH", "14"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_LSB", "26"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_MAXIMUM", "7"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_MINIMUM", "6"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_MSB", "27"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_OFF_VALUE", "13"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_ON_VALUE", "12"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_POLLING_TIME", "23"),
    ...
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_SIGN", "25"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_SLOPE", "8"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_TOOLTIP", "4"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_UNIT", "11"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_UNKNOWN", "0"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_VALUE", "1"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_VALUE_DEFAULT", "33"),
    ("(gint) ARV_GC_PROPERTY_NODE_TYPE_VALUE_INDEXED", "32"),
    ...
    ("(gint) ARV_STATUS_NOT_CONNECTED", "5"),
    ("(gint) ARV_STATUS_PROTOCOL_ERROR", "4"),
    ("(gint) ARV_STATUS_SUCCESS", "0"),
    ("(gint) ARV_STATUS_TIMEOUT", "1"),
    ("(gint) ARV_STATUS_TRANSFER_ERROR", "3"),
    ("(gint) ARV_STATUS_UNKNOWN", "-1"),
    ("(gint) ARV_STATUS_WRITE_ERROR", "2"),
